	...
	*/
	...
	protected function _doQuery($method, $action, $type, $obj, $callbacks, $webapp_ID, $priority, &$err, $recur)
	{
		...
		if ($this->supportsAction($action))
		{
			...
			// 29Aug2012 - Josephson
#			echo "\n--------------------------------------------------\n";
#			var_dump($this->_source->understandsQBXML());
#			var_dump($priority);
#			var_dump($recur);
#			echo "\n--------------------------------------------------\n";
			// 29Aug2012 - Josephson
	...
	// 29Aug2012 - Josephson
	// public function to call _doQuery
	public function doQueryInBehalf($method, $action, $type, $obj, $callbacks, $webapp_ID, $priority, &$err, $recur) {
		return $this->_doQuery($method, $action, $type, $obj, $callbacks, $webapp_ID, $priority, $err, $recur);
