...
//$API->getCustomerByName($name, '_get_customer_callbackCOPY', 15);

$API->searchCustomers(array(), '_get_customer_callbackCOPY'); 

function _get_customer_callbackCOPY($method, $action, $ID, $err, $qbxml, $Iterator, $qbres)
{
