...
print("\nTesting how to get employee data...\n");
$empErr = '';
$empCallback = '_write_to_file';
var_dump(__METHOD__, __FILE__, DIRNAME(__FILE__));

$API->doQueryInBehalf(__METHOD__, QUICKBOOKS_QUERY_EMPLOYEE, QUICKBOOKS_OBJECT_EMPLOYEE, $empObj, $empCallback, $source_options['application_id'], null, $empErr, null);
