...
#$username = 'quickbooks';
#$password = 'password';
$username = 'quickbooks.cascadeo.test@gmail.com';
$password = 'iez2a%E$IY';
// $password = 'fuzzword';
...
// 28/29Aug2012 - Josephson (experiment)
// $dsn = 'mysql://root:@localhost/quickbooks_sql';
$dsn = 'mysql://root:@localhost/quickbooks_sql_BACKUP';
